...
Copy the archive to a USB drive. Walk it to the air-gapped system. (Or if the package is larger than your USB capacity, use :doc:`AirGap Transfer </blog/demo-transfer-ollama>` to chunk it across multiple drives.)
...
- Large ML deployments (see the :doc:`Ollama deployment post </blog/demo-transfer-ollama>`)
