...
:date: TBD
:author: AirGap Team
:tags: airgap-transfer, airgap-deploy, ollama, large-models, demo
...
This is where the AirGap suite shines through integration. AirGap Deploy packages everything you need (application, dependencies, models) into a single deployment archive. AirGap Transfer handles the multi-USB orchestration automatically.
...
**Enterprise-Grade Reliability Without Enterprise Cost**

Manual chunking and verification is what humans do wrong. AirGap Transfer automates it with cryptographic checksums, manifest tracking, and resume capability. You get the reliability of expensive commercial tools without the cost or complexity.
...
AirGap Transfer and AirGap Deploy will be available as part of the v1.0.0 release of the AirGap suite. Once released, you'll be able to deploy Ollama and other large applications to air-gapped systems with confidence.
...
- :doc:`Capturing Meeting Notes with AirGap Whisper </blog/demo-whisper-quick-capture>`
- :doc:`Packaging Rust Apps with AirGap Deploy </blog/demo-deploy-rust-app>`

--------------

*From many drives to one system. AirGap Transfer makes multi-USB deployment reliable.*
